...
df = pd.read_csv('/home/gnarwhal/fantasy-football/data/fantasypros/fp_projections.csv') #Will need to run "update_all.py" from data directory to have up to date projections
...
adp_df = pd.read_csv('/home/gnarwhal/fantasy-football/data/fantasypros/adp/PPR_ADP.csv', index_col=0)
...
writer = pd.ExcelWriter('VoR_fleurdeleauge_draftday.xlsx', engine='xlsxwriter')
